...
volatile uint8_t USB_HostEnumState = USB_HOST_STATE_DEVICE_INIT;


const char *USB_HostStateStringTable[7] =
{
    "Initializing",
    "Waiting for USB Device",
    "Device Attached... Enumerating",
    "Device Attached... Getting Capacity",
    "USB Device Ready",
    "USB Device Enumeration Error",
...
void InitUSB_MSC_Host(void)
{
    SystemCoreClockUpdate();

    USB_HostEnumState = USB_HOST_STATE_DEVICE_INIT;
...
{
    DEBUGOUT(("USB Device Attached on port %d\r\n"), corenum);
...
{
    DEBUGOUT(("\r\nUSB Device Unattached on port %d\r\n"), corenum);
...
void EVENT_USB_Host_DeviceEnumerationComplete(const uint8_t corenum)
{
    ...
    USB_HostEnumState = USB_HOST_STATE_DEVICE_ATTACHED_GET_DISK_CAPACITY;
}
...
void EVENT_USB_Host_HostError(const uint8_t corenum, const uint8_t ErrorCode)
{
    ...
    USB_HostEnumState = USB_HOST_STATE_HOST_ERROR;
...
uint32_t FSUSB_GetDeviceCapacity(DISK_HANDLE_T *hDisk)
{
